  ...
  Troop copyWith({
    ...
    String? troopCode,
      ...
      Troop(
        ...
        troopCode: troopCode ?? this.troopCode,
        createdAt: createdAt,
...
class Scout {
  ...
  Map<String, dynamic> toMap() => {
        ...
        'leaf_badges': leafBadges,
        'leaf_badge_offset': leafBadgeOffset,
        'twig_badges': twigBadges,
        'is_active': isActive ? 1 : 0,
        'created_at': createdAt.toIso8601String(),
        'updated_at': updatedAt.toIso8601String(),
      };
...
class TwigBadgeHistory {
  ...
  final String? eventId;
  final String status; // 'pending' | 'awarded'
  ...
  factory TwigBadgeHistory.fromMap(Map<String, dynamic> m) => TwigBadgeHistory(
        ...
        awardedAt: m['awarded_at'] != null
            ? DateTime.parse(m['awarded_at'] as String)
            : null,
        createdAt: DateTime.parse(m['created_at'] as String),
        updatedAt: DateTime.parse(m['updated_at'] as String),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        'event_id': eventId,
        'status': status,
        'awarded_at': awardedAt?.toIso8601String().split('T').first,
        'created_at': createdAt.toIso8601String(),
        'updated_at': updatedAt.toIso8601String(),
      };
}
